...
namespace Modules\History\Repositories\Backend\History;

use Modules\History\Models\History\History;
...
class EloquentHistoryRepository implements HistoryContract
{
    ...
    {
        return view('views::backend.history.partials.list', ['history' => $history, 'paginate' => $paginate])
            ->render();
    }
